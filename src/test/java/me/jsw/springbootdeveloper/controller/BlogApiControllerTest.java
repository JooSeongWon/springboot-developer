...
import me.jsw.springbootdeveloper.repository.BlogRepository;
...
class BlogApiControllerTest {
    ...
    public void findArticle() throws Exception {
        ...
        resultActions
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.content").value(content)) //JSON 응답 본문을 쿼리하여 특정 JSON 필드의 값을 검증할 수 있는 방법
                .andExpect(jsonPath("$.title").value(title)); //JSON 응답을 자바 객체로 명시적으로 변환하는 과정 없이도 원하는 필드가 원하는 값을 가지고 있는지 테스트할 수 있습니다.
    }
